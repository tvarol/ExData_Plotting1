...
# Top right
with(selected_data, plot(selected_data$DateTime, selected_data$Voltage,
...
# Bottom right
with(selected_data, plot(selected_data$DateTime, selected_data$`Global Reactive Power`,
